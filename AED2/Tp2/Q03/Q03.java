...
class Celula 
{
 ...
 class Fila 
 {
   ...
   public Fila () // vai ler os registros / ira fazer a media arredondada da despesa docente 
   {
      this(5);
      n = 0;

   }// fim construtor da clas/se
   ...
   public int media()
   {
      ...
      for(Celula i = primeiro.prox; i != null; i = i.prox)
      {
        ...
        m = m + i.elemento.getIdade();
        cont++;  
      }  
      return ((int)Math.round(m/cont));
  ...
  public static void main (String [] args) throws Exception
   {
      ...
      for(int hg = 0; hg < k; hg++)
       {
           MyIO.println(printar[hg]);
       } 
