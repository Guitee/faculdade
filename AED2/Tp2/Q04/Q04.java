...
class ListaDupla 
{
  ...
  public void inserirInicio(Presidente p) 
  {
  ...
  public void inserirFim(Presidente p) 
  {
  ...
  public void inserir(Presidente p, int pos) throws Exception 
  {
    int tamanho = tamanho();
  ...
  public int tamanho() 
  {
   ...
   public void swap(int aux1 , int aux2)
   {
      ...
      for(int k = 0; k != aux1; k++, tmp1 = tmp1.prox);
      for(int k = 0; k != aux2; k++, tmp2 = tmp2.prox);
      
      Presidente pre = tmp1.elemento;
  ...
  // construtor quickSort
   public void quickSort()
   {
      quickSort(0,tamanho()-1);       
   }// fim construtor do quickSort()
   ...
   { 
      ...
      CelulaDupla cdDir = primeiro.prox;
      CelulaDupla cdEsq = primeiro.prox;
      CelulaDupla cdPivo = primeiro.prox;
       //a celula ira caminhar ate o dir
      for(int k = 0; k != dir; cdDir = cdDir.prox, k++);
       //a celula ira caminhar ate a esq
      for(int k = 0; k != esq; cdEsq = cdEsq.prox, k++);
      //a celula ira caminhar ate a esq
      for(int k = 0; k != pivo; cdPivo = cdPivo.prox, k++);
      
      Presidente meio = cdPivo.elemento;
         
      while(i<=j)
      {
         while(cdEsq.elemento.getInicioMandato().compareTo(meio.getInicioMandato()) < 0 )
         {
            cdEsq = cdEsq.prox;
            i++;
         ...
         while(cdDir.elemento.getInicioMandato().compareTo(meio.getInicioMandato()) > 0)
         {
            cdDir = cdDir.ant; 
            j--;
            this.setComparacoes(this.getComparacoes()+1);
...
public class Q04
 {
     ...
     try
     {
        FileWriter matri = new FileWriter("matrícula_quicksort2.txt");
