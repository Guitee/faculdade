...
class Lista 
{
   ...
   public int contador; // contar as posicoes da lista
...
public class Q07
{
   public static void main (String [] args) throws Exception
     { 
       ...
       HashIndiretoLista ha = new HashIndiretoLista();
              
       while(!arqTmp.contains("FIM") )
       {
       	  ha.inserirInicio(Presidente.ler(arqTmp));
     ...
     try
     {
        FileWriter matri = new FileWriter("matrícula_hashIndireta.txt");
