 ...
 class FilaC 
{
   ...
   private int first; //primeiro indice da FilaC
   private int last; //ultimo indice da FilaC
 
   //Construtor da classe.
    
   public FilaC () // vai ler os registros / ira fazer a media arredondada da despesa docente 
   {
      this(5);
   ...
   public void media()
   {
      ...
      while( i != last )
      {
         m = m + this.array[i].getIdade();
         cont++;
        i = ((i + 1) % array.length);
      }//fim while
      MyIO.println((int)Math.round(m/cont));
  ...
  public void mostrarMedia ()
   {
      ...
      while( i != last )
      {
        media += array[i].getIdade();
        i = ((i + 1) % array.length);
        lastI = i;
      }//fim while

    if(!(media == 0))
        MyIO.println(media/lastI);
  }//fim mostrarMedia()

  //Metodo que ira enfileirar os elementos na fila circular 
   ...
   //Metodo que ira desenfileirar os elementos na fila circular 
   ...
   public boolean pesquisar(Presidente p)
   {
      ...
      for (int i = first; i < last && retorno == false; i++) 
      {
         retorno = (array[i] == p);
      }
      return retorno;
...
public class Q04
{
   public static void main (String [] args) throws Exception
   {
       ...
       int i = 0;
       FilaC filac  = new FilaC();
       Presidente p = new Presidente();
             
       while(!arqTmp.equals("FIM") )
       {
          filac.inserir(Presidente.ler(arqTmp));
      ...
      for(int j = 0; j < op; j++)
      {
        ...
        {
          case "I":
           filac.inserir(Presidente.ler(entrada[1]));
           break;
