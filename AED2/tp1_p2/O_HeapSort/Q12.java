 ...
 class Lista 
{
   ...
   //constroi o heap com o tamanho recebido por parametro
   public void build (int t) 
   {// com o compareTo, a data se for maior , ira retornar um valor maior que 0
      for(int i = t; i > 1 && (array[i].getDataNascimento().compareTo(array[i/2].getDataNascimento()) > 0 ); i/=2 )
      {
         swap(i,i/2);
      }   
   }// fim build()     
   
   // filho tem smp que ser menor que o pai 
   public void rebuild(int t)
   {
      ...
      while( pai <= t/2)
      {
         if( (array[2*pai].getDataNascimento().compareTo(array[2*pai+1].getDataNascimento()) > 0 ) || (2*pai == t))
         {
            filho = 2*pai;
          ...
          {
            if(array[2*pai].getDataNascimento().compareTo(array[2 * pai + 1].getDataNascimento()) == 0)
             {
               this.setComparacoes(this.getComparacoes()+1);
             } 
             filho = 2* pai + 1;
         ...
         if(array[pai].getDataNascimento().compareTo(array[filho].getDataNascimento()) < 0)
         {
            this.setComparacoes(this.getComparacoes()+1); 
            swap(pai,filho);
            pai = filho;           
...
public class Q12
 {
     ...
     try
     {
        FileWriter matri = new FileWriter("matrícula_heapsort.txt");
