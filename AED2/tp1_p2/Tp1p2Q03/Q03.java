 ...
 class Pilha 
{
   ...
   public void inserirFim(Presidente p) throws Exception // metodo que empilha a pilha  
   {
      //validar insercao
      if(top >= array.length)
      {
   ...
   public Presidente removerFim() throws Exception // metodo que desempilha a pilha 
   {
      //validar remocao
      if (top == 0) 
      {
...
public class Q03
{
   public static void main (String [] args) throws Exception
   {
       ...
       {
          pilha.inserirFim(Presidente.ler(arqTmp));
      ...
      for(int j = 0; j < op; j++)
      {
        ...
        {
          case "I":
           pilha.inserirFim(Presidente.ler(entrada[1]));
           break;
