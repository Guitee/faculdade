 ...
 class Lista 
{
   ...
   // A utility function to get maximum value in arr[] 
    public  int getMax(Presidente arr[], int n) 
    { 
        int mx = arr[0].getId(); 
        for (int i = 1; i < n; i++) 
          if (arr[i].getId() > mx) 
    ...
    public void countSort(Presidente arr[], int n, int exp) 
    { 
        Presidente output[] = new Presidente [n]; // output array 
        int i; 
    ...
    // Radix Sort 
    public  void radixsort(Presidente arr[], int n) 
    { 
...
public class Q17
 {
     ...
     { 
      ...
      lista.radixsort(lista.array , lista.n); 
     ...
     try
     {
        FileWriter matri = new FileWriter("matrícula_radixSort.txt");
