...
class Presidente
{
  ...
  public Presidente clone ()
   ...
   {  
      ...
      Presidente pre[] = new Presidente [100];
...
class Lista 
{
   ...
   // Return minimum index
    //seleciona o menor e troca 
   public void selectionSortRec(int indice)
   {      
      //MyIO.println(">>>" + indice);
      if (indice >= n-1) 
      {
      ...
      for (int i = (indice + 1); i < n; i++) 
      {
        ...
        swap(menor,indice);
         //MyIO.println(">>>>" + (indice+1));
        selectionSortRec(indice+1);
                     
   }// fim selectionSortRec()
 }//fim class Lista
 ...
 public class Q09
 {
     ...
     try
     {
        FileWriter matri = new FileWriter("matrícula_selecaoRecursivo.txt");
